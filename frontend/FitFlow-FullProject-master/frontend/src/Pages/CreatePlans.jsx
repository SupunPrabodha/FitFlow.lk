...
const planSchema = yup.object({
    ...
    // Equipments validated separately since it's handled by CreatableSelect
});
    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-gray-100">
            <div className="bg-white py-10 px-8 lg:px-16 rounded-lg shadow-lg w-full max-w-3xl">
                <h2 className="text-2xl font-semibold text-center mb-6">Create A Plan Here</h2>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div>
                        ...
                        <CreatableSelect
                            ...
                            className="block w-full border border-gray-300 rounded-md bg-white py-2 px-3 text-gray-900 focus:ring focus:ring-indigo-300"
                        />
                        {(!selectedOption || selectedOption.length === 0) && errors.equipments && (
                            <p className="text-red-500">At least one equipment is required</p>
                        )}
                    </div>

                    <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
                        <div className="lg:w-1/2 w-full">
                            <label className="block mb-2 text-lg">Upload Photos</label>
                            <input
                                type="url"
                                placeholder="paste workout plan photos URL:https://weshare.com/img1"
                    ...
                    <div className="w-full">
                        ...
                        <textarea
                            className="w-full pl-3 py-1.5 border border-gray-800 focus:outline-none placeholder-gray-400 rounded-md"
                            rows={6}
                            defaultValue="A calming yoga session focused on improving flexibility and relaxation. Great for recovery days and stress relief"
